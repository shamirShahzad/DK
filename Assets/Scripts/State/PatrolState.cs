...
namespace DK
{
    public class PatrolState : State
    {
        ...
        {
            SearchForTargetWhilePatroling(enemy);
        ...
        private void SearchForTargetWhilePatroling(EnemyManager aiCharacter)
        {
            Collider []
            colliders = Physics.OverlapSphere(transform.position, aiCharacter.detectionRadius, detectionLayer);
